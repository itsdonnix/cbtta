...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $ujian_susulan_checkbox = mysqli_real_escape_string($koneksi, $_POST['ujian_susulan']);

    $ujian_susulan = isset($ujian_susulan_checkbox) && $ujian_susulan_checkbox == 'on' ? 1 : 0;
    // var_dump($ujian_susulan);
    // die();
    ...
    if ($tipe_soal == 'Pilihan Ganda' || $tipe_soal == 'Pilihan Ganda Kompleks') {
        ...
        $query = "INSERT INTO butir_soal (kode_soal, nomer_soal, pertanyaan, tipe_soal,
                  pilihan_1, pilihan_2, pilihan_3, pilihan_4, jawaban_benar, status_soal, jenis_ujian)
                  VALUES ('$kode_soal', '$nomer_soal', '$pertanyaan', '$tipe_soal',
                  '$pilihan_1', '$pilihan_2', '$pilihan_3', '$pilihan_4', '$jawaban_benar', 'Aktif', $ujian_susulan)";
        ...
        $query = "INSERT INTO butir_soal (kode_soal, nomer_soal, pertanyaan, tipe_soal,
                  pilihan_1, pilihan_2, pilihan_3, pilihan_4, jawaban_benar, status_soal, jenis_soal)
                  VALUES ('$kode_soal', '$nomer_soal', '$pertanyaan', '$tipe_soal',
                  '$pilihan_1', '$pilihan_2', '$pilihan_3', '$pilihan_4', '$jawaban_benar', 'Aktif', $ujian_susulan)";
        ...
        $query = "INSERT INTO butir_soal (kode_soal, nomer_soal, pertanyaan, tipe_soal,
              jawaban_benar, status_soal, jenis_ujian)
              VALUES ('$kode_soal', '$nomer_soal', '$pertanyaan', '$tipe_soal',
              '$jawaban_benar', 'Aktif', $ujian_susulan)";
                                    ...
                                    <form method="POST">
                                        ...
                                        <div class="mb-3">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="ujian_susulan" id="flexCheckChecked">
